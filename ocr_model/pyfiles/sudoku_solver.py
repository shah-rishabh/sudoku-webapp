...
from sudoku_image_parser import extract_digit
from sudoku_image_parser import find_puzzle
...
for y in range(0, 9):
    ...
    for x in range(0, 9):
        ...
        cv2.imwrite(f"ocr_model/images/dump/temp_{x}_{y}.jpg", cell)
...
cv2.imwrite("ocr_model/images/dump/temp6.jpg", puzzleImage)
temp = Image.open("ocr_model/images/dump/temp6.jpg")
temp.show()
